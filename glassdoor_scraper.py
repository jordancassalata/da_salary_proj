...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    url= "https://www.glasdoor.com/Job/jobs.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword="+keyword+"&sc.keyword"+keyword+"&sc.keyword=data+analyst&locT=&locId=&jobType="    #<-Modification made by Ken Jee
